<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SamlBridgeRedirection.aspx.cs" Inherits="SamlBridgeRedirection" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
	<head runat="server">
		<title>SamlBridge - Redirecting back to ADFS Resource</title>
		<link href="css/SsoError.css" rel="stylesheet" type="text/css" />
	</head>
	<body>
		<asp:Panel ID="RedirectClient" runat="server">
			<asp:Literal ID="RedirectFormPlaceholder" runat="server" />
			<noscript>
				<div>
